...
def main():
    ...
    try:
        ...
        model_train.load_weights('exp_100_sorted/model.h5')
        ...
        #preprocess image
        count = 0
        filename = 'data_10/images.txt'
        img_dir = 'data_10/images/'

        size = 0
        with open(filename) as handle:
            for line in handle:
                size = size + 1
        fea_array = [[0 for i in range(2048)] for j in range(size)]
        ...
        with open('feature10.txt', 'w') as handle:
